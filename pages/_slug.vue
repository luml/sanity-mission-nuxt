      ...
      <div class="details">
        ...
        <div class="description">
          <p style="display: block">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis voluptatibus exercitationem laborum! Dolor veritatis id asperiores ratione blanditiis quaerat excepturi quas animi provident laboriosam. Tempore officia consectetur quo ex laudantium.
          </p>
        </div>
        <div class="quantity">
          <h3>QUANTITY</h3>
...
export default {
  async asyncData({ params, $sanity }) {
    const query = groq`*[_type == 'product' && slug.current == "${params.slug}"][0]{
      title,
      slug,
      _id,
